...
class App(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.title_label = ctk.Label(self.home_frame, text="Página de Inicio", font=("Arial", 16))
        self.title_label.grid(row=0, column=0, pady=10, sticky="w")

        # Crear botones
        self.clients_button = ctk.Button(self.home_frame, text="Clientes", command=self.show_clients, width=20)
        self.clients_button.grid(row=1, column=0, pady=10, sticky="w")

        self.monthly_tables_button = ctk.Button(self.home_frame, text="Tablas mensuales", command=self.show_monthly_tables, width=20)
...
class ClientsFrame(ctk.Frame):
    ...
    def create_widgets(self):
        self.title_label = ctk.Label(self, text="Clientes", font=("Arial", 16))
        self.title_label.grid(row=0, column=0, pady=10, sticky="w")

        self.back_button = ctk.Button(self, text="Volver", command=self.go_back, width=20)
